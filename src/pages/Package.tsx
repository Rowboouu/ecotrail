...
const Package = () => {
  ...
  return (
    <div
      id="package"
      className="w-full min-h-screen flex flex-col items-center justify-center font-[Inter] gap-4 md:px-0 px-8"
    >
        ...
        {packages.map((pkg) => (
          ...
          >
            ...
            <div className="p-6 gap-2 flex flex-col items-start justify-center">
              ...
              <div className="bg-gray-100 p-2 my-2 rounded-md text-sm text-gray-500 flex items-center gap-2 font-semibold">
...
export default Package as React.ComponentType;
