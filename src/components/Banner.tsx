...
const Banner = () => {
  return (
    <div className="w-full h-auto py-8 flex items-center justify-center">
      <div
        className="w-full h-[80%] py-8 bg-cover bg-center text-white font-[Inter] flex items-center justify-center"
        style={{ backgroundImage: `url(${Island})` }}
      >
        <div className="w-[90%] md:w-[70%] h-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 justify-center items-center">
