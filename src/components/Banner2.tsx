...
const Banner2 = () => {
  return (
    <div className="w-full h-[458px] py-8 md:px-0 px-8 flex items-center justify-center sm:h-auto">
      <div className="w-full md:w-[75%] py-8 bg-[#003233] text-white font-[Inter] flex items-center justify-center rounded-3xl sm:h-auto">
